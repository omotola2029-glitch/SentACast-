...
2024-01-17,Absolutely love it! Highly recommend,5
    ...
    st.info("""
    Upload your CSV file containing product reviews. SentACast will automatically detect review text, date, and rating columns, 
    remove duplicates and empty entries, clean text by removing URLs and special characters, and provide you detailed statistics on the cleaning process.
    """)
    ...
    st.write("<h5 style='text-align: center; color: #6c757d; margin: 5px 0;'>OR</h5>", unsafe_allow_html=True)
    st.write("")
